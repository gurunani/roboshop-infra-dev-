resource "aws_acm_certificate" "gurulabs" {
...
resource "aws_route53_record" "gurulabs" {
  for_each = {
    for dvo in aws_acm_certificate.gurulabs.domain_validation_options : dvo.domain_name => {
